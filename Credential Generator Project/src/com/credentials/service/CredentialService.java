...
//			pwd = pwd + (char)(r.nextInt(123-33)+33);
	...
	private String generateEmailAddress(Employee e, String dept) {
		return e.getFirstName1().toLowerCase() + e.getLastName1().toLowerCase() + "@" + dept + ".abc.com";
	}

	public void showCredentials(Employee e, String dept) {

		System.out.println("Dear " + e.getFirstName1() + " your generated credentials are as follows");
